...
public class TemplateKeyboard implements KeyListener {
    ...
    public Label getWall() {
        ...
        label.setOnMouseEntered(e -> enteredWall(e)); //TODO ändra
        label.setOnMouseExited(e -> exitedLabel(e)); //TODO ändra
        return label;
    }
    ...
    private Label getGoal() {
        ...
        borderView.setFitWidth(squareSize);
        label.setGraphic(borderView);
        label.setOnMouseEntered(e -> { //TODO ändra
            try {
                enteredGoal();
    ...
    private Label getStart() {
        ...
        borderView.setFitWidth(squareSize);
        label.setGraphic(borderView);
        label.setOnMouseClicked(e -> startLevel()); //TODO ändra
        return label;
    }
    ...
    public Label addCollectible() {
        ...
        collectible.addEventHandler(MouseEvent.MOUSE_ENTERED, mouseListener); //TODO ändra
     ...
     */
    private class MouseListener implements EventHandler<MouseEvent> { //TODO ta bort och ersätt med keylistener stuff
